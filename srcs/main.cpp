...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/18 17:02:26 by arguilla          #+#    #+#             */
/*   Updated: 2022/09/18 22:25:20 by arguilla         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	std::cout << "TEST WITH " << CTN << " NAMESPACE" << std::endl;
    std::cout << "*************************************************************************" << std::endl;
    ...
    // NOTE - Get allocator
    {
        ...
        m.insert(ft::make_pair(1, "younes"));
        m.insert(ft::make_pair(2, "choaib"));
        m.insert(ft::make_pair(3, "abdelah"));
